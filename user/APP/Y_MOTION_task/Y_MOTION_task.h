...
/*********函数声明 *************/
extern Y_MOTION_System_t Y_MOTION_move;

extern void Y_MOTION_Setup(void);
extern void Y_MOTION_task(void);
extern void Y_MOTION_rc_filter(fp32 *vy_set, Y_MOTION_System_t *Y_MOTION_move);
